...
#define MM_BASE_MODEM_SYS_FSPATH          "base-modem-sys-fspath"
...
void         mm_base_modem_set_sys_fspath (MMBaseModem *self,
                                           const gchar *sys_fspath);
const gchar *mm_base_modem_get_sys_fspath (MMBaseModem *self);
